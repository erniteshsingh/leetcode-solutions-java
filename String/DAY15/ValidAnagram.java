...
public class ValidAnagram {
     ...
     * Two strings are said to be anagrams if they contain the same characters with
     * the same frequency. Order of characters does not matter.
     * 
     * Approach 1: Brute Force using Two HashMaps
     * Intuition:
     * Store frequency of each character of both strings in two different hashmaps
     * and then compare both maps.
     * 
     * Steps:
     * 
     ...
     * Intuition:
     * Use only one hashmap. Increase frequency for characters of first string and
     * decrease frequency for characters of second string. At the end all values
     * should become zero.
     * 
     * Steps:
     * 
     ...
     * Intuition:
     * Since only lowercase English letters are used, we can replace hashmap with an
     * integer array of size 26. This reduces space complexity.
     * 
     * Steps:
     * 
     * 1. Check length condition.
